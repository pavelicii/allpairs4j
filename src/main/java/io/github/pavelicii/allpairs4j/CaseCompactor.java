...
final class CaseCompactor {
    ...
    static void compact(List<List<Item>> sequences,
                        List<CompactTable> tables,
                        CaseCompleter completer,
                        boolean mergeCases) {
    ...
    private static void mergePairs(List<List<Item>> sequences,
                                   List<CompactTable.Group> groups,
                                   Function<List<Item>, List<Item>> completeCase) {
    ...
    private static List<Map<Integer, Integer>> countTuples(List<List<Item>> sequences,
                                                           List<CompactTable.Group> groups) {
    ...
    private static List<Item> mergeSeed(List<Item> left,
                                        List<Item> right,
                                        List<CompactTable.Group> groups,
