...
public class ConstrainableCase {
    ...
    private static final NoSuchParameterNameException NO_SUCH_PARAMETER_NAME_EXCEPTION = new NoSuchParameterNameException();
    private static final InapplicableParameterException INAPPLICABLE_PARAMETER_EXCEPTION = new InapplicableParameterException();
