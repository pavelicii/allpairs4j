...
final class TestSupport {
     ...
     */
    static void assertCoverage(AllPairs actual,
                               Set<String> conditionalNames,
                               boolean absenceCoverage,
                               Predicate<Case> isValid) {
        ...
        assertThat(combinations(rows, actual.getParameters(), actual.getTestCombinationSize(), absenceCoverage))
                .isEqualTo(combinations(
                        valid,
                        actual.getParameters(),
                        actual.getTestCombinationSize(),
                        absenceCoverage)
                );
    }
     ...
     */
    private static Set<Case> combinations(List<Case> rows,
