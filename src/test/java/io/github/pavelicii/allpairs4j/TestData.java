...
final class TestData {
    ...
    static final Parameter RAM = new Parameter("RAM", 4096, 8192, 16384);
    ...
    static final List<Case> EXPECTED_TRIPLEWISE_CASES = TestSupport.cases(PARAMETERS, new Object[][] {
            {"Chrome", "Windows", 4096, "HDD"},
            {"Edge", "macOS", 8192, "SSD"},
            {"Safari", "Linux", 4096, "SSD"},
            {"Chrome", "Windows", 16384, "SSD"},
            {"Safari", "Linux", 16384, "HDD"},
            {"Edge", "macOS", 4096, "HDD"},
